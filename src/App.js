...
function App() {
  return (
    <div className='px-40 2xl:px-0 bg-white h-screen'>
      <div className='bg-white fixed w-1/4 right-0 h-full bg-gradient-to-t from-white via-[#faeee5] to-[#f08255] overflow-auto z-50'>
        <div className='flex flex-col space-y-8 bg-white h-full ml-[0.1rem]'>
         <div className='flex justify-end mt-4 mr-4'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 text-gray-600 cursor-pointer">
            ...
            {/* section loop images */}
              <div className="py-4">
                ...
                >
                  ...
                  <SwiperSlide>
                    <img className="rounded-md" src="/overlay-2.png"/>
                  </SwiperSlide>
                  <SwiperSlide>
                    <img className="rounded-md" src="/overlay-3.png"/>
                  </SwiperSlide>
                </Swiper>
              </div>
            {/* section loop images */}
      ...
      <div className="2xl:w-1/2 2xl:mx-auto mt-24">
        <div className='grid grid-cols-12 gap-4'>
            ...
            <div className='col-span-4 bg-red-200'>
              <img src='/pub-3.svg' className='object-cover h-full'/>
            </div>
        </div>
      </div>
      <div className="flex flex-col 2xl:w-1/2 2xl:mx-auto space-y-8 mt-24">
        <div className='flex p-4 space-x-4 divide-x-2 divide-gray-200'>
          <div className='text-stone-800 font-bold'>New Arrival</div>
          <div className='pl-4 text-stone-400'>Tag Rated</div>
          <div className='pl-4 text-stone-200'>On Sale</div>
        </div>
        <div className='grid grid-cols-12 gap-8'>
            <div className='flex space-x-4 col-span-12 lg:col-span-6'>
              <div className="bg-[#f5f2ec] p-2 flex justify-center items-center rounded-md">
                <img className="w-20 hover:scale-[1.2] transition delay-200 cursor-pointer" src="/clock-1.svg" />
              </div>
              <div className='flex flex-col space-y-2'>
                <h1>Suoer no inspiration</h1>
                ...
                <div className='flex space-x-4'>
                    <div className='border rounded-md p-1 cursor-pointer hover:opacity-60'>
            ...
            <div className='flex space-x-4 col-span-12 lg:col-span-6'>
              <div className="bg-[#f5f2ec] p-2 flex justify-center items-center rounded-md">
                <img className="w-20 hover:scale-[1.2] transition delay-200 cursor-pointer" src="/shoes.svg" />
              </div>
              <div className='flex flex-col space-y-2'>
                <h1>Coll est top</h1>
                <div className='flex space-x-1'>
            ...
            <div className='flex space-x-4 col-span-12 lg:col-span-6'>
              <div className="bg-[#f5f2ec] p-2 flex justify-center items-center rounded-md">
                <img className="w-20 hover:scale-[1.2] transition delay-200 cursor-pointer" src="/bag.svg" />
              </div>
              <div className='flex flex-col space-y-2'>
                <h1>Coll est top</h1>
                <div className='flex space-x-1'>
            ...
            <div className='flex space-x-4 col-span-12 lg:col-span-6'>
              <div className="bg-[#f5f2ec] p-2 flex justify-center items-center rounded-md">
                <img className="w-20 hover:scale-[1.2] transition delay-200 cursor-pointer" src="/trending-3.svg" />
              </div>
              <div className='flex flex-col space-y-2'>
                <h1>Coll est top</h1>
                <div className='flex space-x-1'>
        ...
        <div className='flex justify-center'>
            <button className='px-8 py-2 border-2 rounded-md border-stone-400 text-stone-500 text-sm font-bold'>View All</button>
        </div>
      </div>

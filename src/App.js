    ...
    <div className='px-40 2xl:px-0 bg-white h-screen'>
      ...
      <div className="flex flex-col 2xl:w-1/2 2xl:mx-auto ">
        ...
        <div className='grid grid-cols-12 gap-4'>
          ...
          <div className='flex flex-col col-span-4 space-y-2 bg-[#f5f2ec] rounded-md relative'>
              <div className='flex justify-end p-2 cursor-pointer'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-black">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                  </svg>
              ...
              <div className='flex divide-x items-center bg-black w-full rounded-bl-md rounded-br-md absolute -bottom-1'>
                  ...
                  <div className='p-2 cursor-pointer'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-white">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
                    </svg> 
                  </div> 
              </div>

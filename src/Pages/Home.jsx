...
import { sum } from '../utilis/helpers';


function Home() {
  return (
    <Layout
      drawerShopping={<DrawerShopping />}
                          ...
                          <div className="grid grid-cols-12 gap-4">
                              <div className="col-span-6">
                                <div className="bg-[#f5f2ec] p-2 flex justify-center items-center">
                                     <img className="w-40 rounded-lg transition delay-200 cursor-pointer" src="/clock-1.svg" />
                                </div>
                              </div>
                              <Link to="/shopping" className="col-span-6">
                                <div className="bg-[#f5f2ec] p-2 flex justify-center items-center">
